...
const homepageNews = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.homepage-news__slider', {
...
const homepageTube = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.homepage-tube__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
...
const homepageQuiz = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.homepage-quiz__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
...
const homepageThanks = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.homepage-tedcoins__thanks .homepage-tedcoins__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
...
const homepageExchange = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.homepage-tedcoins__exchange .homepage-tedcoins__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
...
const deactivatepanelLink = () => {
    const links = document.querySelectorAll('.homepage-panel__link');
...
const activatepanelLink = (link, e) => {
    deactivatepanelLink();
    link.classList.add('active');
    e.preventDefault();
}
...
const hideOptions = () => {
    const options = document.querySelectorAll('.homepage-study__options');
...
const showStudyProgress = () => {
    const progressItems = document.querySelectorAll('.homepage-study__progress');

    if (progressItems.length) {
        progressItems.forEach((progress) => {
            const bar = progress.querySelector('.homepage-study__bar');
...
document.addEventListener('click', (e) => {
    ...
    const panelLink = e.target.closest('.homepage-panel__link');
    if (panelLink) {
        activatepanelLink(panelLink, e);
    }
    ...
    const optionsBtn = e.target.closest('.homepage-study__btn');
    if (optionsBtn) {
        showOptions(optionsBtn);
    }

    const options = e.target.closest('.homepage-study__options');
    if (!options) {
        hideOptions();
    }
